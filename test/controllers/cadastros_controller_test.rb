...
class CadastrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cadastro" do
    assert_difference('Cadastro.count') do
      post cadastros_url, params: { cadastro: { age: @cadastro.age, id: @cadastro.id, name: @cadastro.name } }
    end
  ...
  test "should update cadastro" do
    patch cadastro_url(@cadastro), params: { cadastro: { age: @cadastro.age, id: @cadastro.id, name: @cadastro.name } }
